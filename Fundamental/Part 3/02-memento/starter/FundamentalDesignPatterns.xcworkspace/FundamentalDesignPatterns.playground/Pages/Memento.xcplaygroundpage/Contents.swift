...
print("New Game AttemptRemaining: \(game.state.attemptRemaining)")

// Load Game
game = try! gameSystem.load(title: "Best Game Ever")
print("Loaded Game Score: \(game.state.score)")
print("Loaded Game AttemptRemaining: \(game.state.attemptRemaining)")
